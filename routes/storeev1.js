...
router.get(
  "/orderdetail/create",
  orderDetail_controller.orderdetail_create_get
);

// POST request for creating OrderDetail
router.post(
  "/orderdetail/create",
  orderDetail_controller.orderdetail_create_post
);

// GET request to delete OrderDetail
router.get(
  "/orderdetail/:id/delete",
  orderDetail_controller.orderdetail_delete_get
);

// POST request to delete OrderDetail
router.post(
  "/orderdetail/:id/delete",
  orderDetail_controller.orderdetail_delete_post
);

// GET request to update OrderDetail
router.get(
  "/orderdetail/:id/update",
  orderDetail_controller.orderdetail_update_get
);

// POST request to update OrderDetail
router.post(
  "/orderdetail/:id/update",
  orderDetail_controller.orderdetail_update_post
);
